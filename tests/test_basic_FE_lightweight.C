...
// This test frontend is different from test_basic_FE.C because
 ...
 */
int test_char( Network * net, Stream *stream, bool anonymous, bool block)
{
    Stream *recv_stream;
 ...
 */
int test_short( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_ushort( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_int( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_uint( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_long( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_ulong( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_double( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
 ...
 */
int test_alltypes( Network * net, Stream *stream, bool anonymous, bool block )
{
    Stream *recv_stream;
    int num_received=0, num_to_receive=0;
    int tag;
