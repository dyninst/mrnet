...
const char * Pass_format_string = "%d";
void Pass( std::vector< PacketPtr >& packets_in,
...
void SumThenLimit42( std::vector< PacketPtr >& packets_in,
                 std::vector< PacketPtr >& packets_out,
                 std::vector< PacketPtr >& /* packets_out_reverse */,
                 void ** /* client data */,
                 PacketPtr& /* params */ )
...
const char * SumOnly_format_string = "%d";
void SumOnly( std::vector< PacketPtr >& packets_in,
                 std::vector< PacketPtr >& packets_out,
                 std::vector< PacketPtr >& /* packets_out_reverse */,
                 void ** /* client data */,
                 PacketPtr& /* params */ )
