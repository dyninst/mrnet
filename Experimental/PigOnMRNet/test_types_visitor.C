...
// unit test:
// [1] create a bag of tuples, where one tuple contains a map
// [2] serialize it
// [3] deserialize it
// [4] does it match the original bag?
//
// after execution:
// the contents of both before.txt and after.txt should match the following:
// {( 311  666 [  1 # 13    2 # 42  ])( 100  200 )}
int main()
{
    simple_item* key_1 = create_simple_item(1);
    simple_item* key_2 = create_simple_item(2);
    complex_item* value_1 = create_complex_item(13);
    complex_item* value_2 = create_complex_item(42);
    ...
    complex_item* value_3 = create_complex_item(311);
    complex_item* value_4 = create_complex_item(666);
    ...
    complex_item* value_5 = create_complex_item(100);
    complex_item* value_6 = create_complex_item(200);
