...
void NetworkTopology::add_BackEnd( uint32_t rprank, uint32_t rcrank, 
                                   char* rchost, uint16_t rcport, bool upst )
{
...
void NetworkTopology::add_CP( uint32_t rprank, uint32_t rcrank, 
                              char* rchost, uint16_t rcport, bool upst )
{
