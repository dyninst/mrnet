...
void
Network::get_Identity( SerialGraph* sg,
                    int & n,
...
void
Network::CreateHostDistributions( NetworkTopology::Node* node,
                             bool isRoot,
...
/*
bool
Network::bootstrap_communication_distributed( libi_sess_handle_t sess,
                              NetworkTopology* nt,
                              bool isForMW,
                              bool launchBE,
                              void* & ports,
...
std::string
Network::get_NetSettingName( int s )
{
     std::string ret;
